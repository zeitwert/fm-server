...
```
cd existing_repo
git remote add origin https://gitlab.com/zeit-wert/zeit-wert/zeitwert.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/zeit-wert/zeit-wert/zeitwert/-/settings/integrations)
