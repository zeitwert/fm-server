...
open class ObjAccountPersistenceProvider : JooqObjPersistenceProviderBase<ObjAccount>() {
    ...
    override fun getRepository(): ObjAccountRepository = _repository
    ...
    override fun fromAggregate(aggregate: ObjAccount): UpdatableRecord<*> {
    ...
    @Suppress("UNCHECKED_CAST")
    override fun loadExtension(aggregate: ObjAccount, objId: Int?) {
