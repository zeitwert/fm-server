...
enum class CodeContentType(
    ...
    DOCX("docx", "Word 2007", CodeContentKind.DOCUMENT, "docx", "application/vnd.openxmlformats-officedocument.wordprocessing"),
    XLSX("xlsx", "Excel 2007", CodeContentKind.DOCUMENT, "xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"),
    PPTX("pptx", "Powerpoint 2007", CodeContentKind.DOCUMENT, "pptx", "application/vnd.openxmlformats-officedocument.presentationml.presentation"),
    ...
    companion object Enumeration : EnumerationBase<CodeContentType>(CodeContentType::class.java) {
        ...
        @JvmStatic
        fun getContentType(mimeType: String?, fileName: String?): CodeContentType? {
