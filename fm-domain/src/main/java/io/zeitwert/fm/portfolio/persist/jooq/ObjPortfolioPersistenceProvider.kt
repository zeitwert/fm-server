...
open class ObjPortfolioPersistenceProvider : JooqObjPersistenceProviderBase<ObjPortfolio>() {
    ...
    override fun getRepository(): ObjPortfolioRepository = _repository
    ...
    override fun fromAggregate(aggregate: ObjPortfolio): UpdatableRecord<*> {
    ...
    private fun storeReferenceSet(aggregate: ObjPortfolio, objId: Int, propertyName: String, listTypeId: String) {
        dslContext().deleteFrom(ObjPartItem.OBJ_PART_ITEM)
    ...
    @Suppress("UNCHECKED_CAST")
    override fun loadExtension(aggregate: ObjPortfolio, objId: Int?) {
    ...
    private fun loadReferenceSet(aggregate: ObjPortfolio, objId: Int, propertyName: String, listTypeId: String) {
        @Suppress("UNCHECKED_CAST")
