...
enum class CodeBuildingPart(
	...
	fun getTimeValue(relativeAge: Double): Double {
		...
		return c0 + c1 * relativeAge + c2 * relativeAge.pow(2.0) + c3 * relativeAge.pow(3.0) + c4 * relativeAge.pow(4.0) + c5 * relativeAge.pow(
			5.0,
		) + c6 * relativeAge.pow(6.0) + c7 * relativeAge.pow(7.0) + c8 * relativeAge.pow(8.0) + c9 * relativeAge.pow(9.0) + c10 * relativeAge.pow(
			10.0,
		)
	}
	...
	private fun fDerivative(relativeAge: Double): Double =
		c1 + 2 * c2 * relativeAge + 3 * c3 * relativeAge.pow(2.0) + 4 * c4 * relativeAge.pow(3.0) + 5 * c5 * relativeAge.pow(
			4.0,
		) + 6 * c6 * relativeAge.pow(5.0) + 7 * c7 * relativeAge.pow(6.0) + 8 * c8 * relativeAge.pow(7.0) + 9 * c9 * relativeAge.pow(
			8.0,
