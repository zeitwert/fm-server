...
class ProjectionController {
	...
	fun getElementProjection(@PathVariable elementId: String): ResponseEntity<List<ProjectionPeriod>> {
	...
	@Throws(InterruptedException::class, ExecutionException::class)
	fun getRestoredTimeValue(@PathVariable elementId: String): ResponseEntity<List<Double>> {
		val buildingPart = getBuildingPart(elementId)!!
	...
	@Throws(InterruptedException::class, ExecutionException::class)
	fun getRelativeAge(@PathVariable elementId: String, @PathVariable timeValue: Double): ResponseEntity<Double?> {
		val buildingPart = getBuildingPart(elementId)!!
