...
abstract class ObjBuildingBase(
    ...
    private val _historicPreservation: EnumProperty<CodeHistoricPreservation> = this.addEnumProperty("historicPreservation", CodeHistoricPreservation::class.java)
    ...
    private val _coverFoto: ReferenceProperty<ObjDocument> = this.addReferenceProperty("coverFoto", ObjDocument::class.java)
    ...
    private val _buildingType: EnumProperty<CodeBuildingType> = this.addEnumProperty("buildingType", CodeBuildingType::class.java)
    private val _buildingSubType: EnumProperty<CodeBuildingSubType> = this.addEnumProperty("buildingSubType", CodeBuildingSubType::class.java)
    ...
    private val _notInsuredValue: BaseProperty<BigDecimal> = this.addBaseProperty("notInsuredValue", BigDecimal::class.java)
    private val _notInsuredValueYear: BaseProperty<Int> = this.addBaseProperty("notInsuredValueYear", Int::class.java)
    private val _thirdPartyValue: BaseProperty<BigDecimal> = this.addBaseProperty("thirdPartyValue", BigDecimal::class.java)
    private val _thirdPartyValueYear: BaseProperty<Int> = this.addBaseProperty("thirdPartyValueYear", Int::class.java)

    private val _ratingList: PartListProperty<ObjBuildingPartRating> = this.addPartListProperty("ratingList", ObjBuildingPartRating::class.java)

    private val _contactSet: ReferenceSetProperty<ObjContact> = this.addReferenceSetProperty("contactSet", ObjContact::class.java)

    override fun aggregate(): ObjBuilding = this

    override fun taskRepository() = getRepository().taskRepository

    override fun getRepository(): ObjBuildingRepository {
    ...
    private fun addCoverFoto() {
        ...
        val coverFoto = documentRepo.create(tenantId as Int, null, OffsetDateTime.now())
        coverFoto.name = "CoverFoto"
        coverFoto.contentKind = CodeContentKind.getContentKind("foto")
        coverFoto.documentKind = CodeDocumentKind.getDocumentKind("standalone")
        coverFoto.documentCategory = CodeDocumentCategory.getDocumentCategory("foto")
        documentRepo.store(coverFoto, null, OffsetDateTime.now())
