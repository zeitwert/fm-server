...
class BuildingLocationController(
	...
	protected fun getMap(@PathVariable("id") id: Int): ResponseEntity<ByteArray?> {
	...
	fun getAddress(@RequestBody request: GeocodeRequestDto): ResponseEntity<GeocodeResponseDto?> {
