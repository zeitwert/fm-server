...
import io.zeitwert.fm.building.adapter.rest.dto.BuildingTransferDto
import io.zeitwert.fm.building.adapter.rest.dto.BuildingTransferElementRatingDto
import io.zeitwert.fm.building.adapter.rest.dto.NoteTransferDto
import io.zeitwert.fm.building.adapter.rest.dto.TransferMetaDto
...
class BuildingImportExportController {
	...
	private fun getFileName(building: ObjBuilding): String =
		(if (building.account != null) building.account!!.name + " " else "") + building.name + ".zwbd"
