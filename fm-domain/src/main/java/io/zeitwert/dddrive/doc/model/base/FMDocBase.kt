package io.zeitwert.dddrive.doc.model.base
...
import io.zeitwert.dddrive.ddd.model.EntityWithExtn
...
abstract class FMDocBase(
	...
	override fun doAfterCreate(sessionContext: SessionContext) {
		...
		if (this is ItemWithAccount && (sessionContext as io.zeitwert.app.model.SessionContext).hasAccount()) {
