 ...
 *
 * This configuration enables jOOQ-based persistence for aggregates using the new
 * dddrive (io.dddrive.core.*) framework. It coexists with the existing persistence
 * infrastructure (which uses the old io.dddrive.* packages) to allow gradual migration.
 *
