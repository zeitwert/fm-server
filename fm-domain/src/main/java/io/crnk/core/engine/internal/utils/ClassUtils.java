...
public class ClassUtils {
	...
	/**
	 * <p>
	 * Return a list of class getters. Supports inheritance and overriding, that is
	 * when a method is found on the lowest level of inheritance chain, no other
	 * method can override it. Supports inheritance and doesn't return synthetic
	 * methods.
	 * <p>
	 * A getter:
	 * <ul>
	...
	public static List<Method> getClassGetters(Class<?> beanClass) {
		...
		getClassGetters(beanClass, resultMap, results);
		return results;
	}
	...
	private static void getClassGetters(Class<?> currentClass, Map<String, Method> resultMap,
		...
		for (Class<?> intf : currentClass.getInterfaces()) {
			getClassGetters(intf, resultMap, results);
		}
		getClassGetters(currentClass.getSuperclass(), resultMap, results);
	}
	...
	/**
	 * Return a list of class setters. Supports inheritance and overriding, that is
	 * when a method is found on the lowest level of inheritance chain, no other
	 * method can override it. Supports inheritance and doesn't return synthetic
	 * methods.
	 *
