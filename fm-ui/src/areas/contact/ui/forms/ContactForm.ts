...
import { Account, ACCOUNT_API, ContactModel, ContactModelType } from "@zeitwert/ui-model";
import { Form, FormDefinition } from "mstform";

export const ContactFormDef: FormDefinition<ContactModelType> = {
	id: new IdField(),
...
const ContactForm = new Form(ContactModel, ContactFormDef);
