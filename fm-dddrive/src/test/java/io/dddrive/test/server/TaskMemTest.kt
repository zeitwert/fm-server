...
class TaskMemTest : PropertyChangeListener {
  ...
  @Autowired private lateinit var taskRepo: DocTaskRepository

  @Autowired private lateinit var caseDefEnum: CodeCaseDefEnum

  @Autowired private lateinit var caseStageEnum: CodeCaseStageEnum
