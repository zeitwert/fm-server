...
create table code_address_channel (
	id																		varchar(40)					not null,
	--
	address_type_id												varchar(40)					not null references code_address_type(id),
	name																	varchar(100)				not null,
	--
	primary key (id)
);
...
create table obj_contact_part_address (
	...
	seq_nr																integer,
	--
	address_channel_id										varchar(40)					not null references code_address_channel(id),
	--
	name																	varchar(100),
	--
	street																varchar(100),
