...
update obj_building b set building_nr = '1.1' where b.zip||'-'||b.street||'-'||b.name = '7304--Rathaus';
update obj_building b set building_nr = '1.2' where b.zip||'-'||b.street||'-'||b.name = '7304--Alte Turnhalle';

update obj_building b set building_nr = '2.1' where b.zip||'-'||b.street||'-'||b.name = '8253-Schulstr. 38-Kindergarten Basadingen';
update obj_building b set building_nr = '2.2' where b.zip||'-'||b.street||'-'||b.name = '8253-Schulstrasse 5-best. Schulhaus Zentrum';
update obj_building b set building_nr = '2.2.1' where b.zip||'-'||b.street||'-'||b.name = '8253-Schulstrasse 5-Sanierung Schulhaus Zentrum';
update obj_building b set building_nr = '2.2.2' where b.zip||'-'||b.street||'-'||b.name = '8253-Schulstrasse 5-Janus Schulhaus Zentrum';
update obj_building b set building_nr = '2.3' where b.zip||'-'||b.street||'-'||b.name = '8255-Bahnhofstrasse 1-Schulhaus Schlattingen';
update obj_building b set building_nr = '2.4' where b.zip||'-'||b.street||'-'||b.name = '8253-Schützenstrasse-Kindergarten Schupfenzelg';

update obj_building b set building_nr = '3.1' where b.zip||'-'||b.street||'-'||b.name = '8479-Feldistrasse 6/8-Laubenhuus';

update obj_building b set building_nr = '4.1.1' where b.zip||'-'||b.street||'-'||b.name = '8266-Feldbach-Oberstufenschulhaus Feldbach';
update obj_building b set building_nr = '4.2' where b.zip||'-'||b.street||'-'||b.name = '8266-Frauenfelderstrasse 10-Hub gelb';
update obj_building b set building_nr = '4.3' where b.zip||'-'||b.street||'-'||b.name = '8266-Seestrasse 126-Seeschulhaus';
update obj_building b set building_nr = '4.4' where b.zip||'-'||b.street||'-'||b.name = '8266-Feldbach-Sport- und Mehrzweckhalle';
update obj_building b set building_nr = '4.5.1' where b.zip||'-'||b.street||'-'||b.name = '8266-Frauenfelderstrasse 8-Hub rot';
update obj_building b set building_nr = '4.6' where b.zip||'-'||b.street||'-'||b.name = '8266-Zelgistrasse 8-Doppelkindergarten';
update obj_building b set building_nr = '4.7' where b.zip||'-'||b.street||'-'||b.name = '8266-Hubstrasse-Hub blau';

update obj_building b set building_nr = '5.1' where b.zip||'-'||b.street||'-'||b.name = '5620-Badstrasse 3-Schulhaus Isenlauf';
update obj_building b set building_nr = '5.2' where b.zip||'-'||b.street||'-'||b.name = '5620-Kapuzinerhügel 5-Kindergarten Kapuzinerhügel';
update obj_building b set building_nr = '5.3' where b.zip||'-'||b.street||'-'||b.name = '5620-Wohlerstrasse-Reussbrücke-Saal, Zwischenbau';
update obj_building b set building_nr = '5.4' where b.zip||'-'||b.street||'-'||b.name = '5620-Kreuzmattstrasse 8-Feuerwehrlokal, SR und Wg.';
update obj_building b set building_nr = '5.5' where b.zip||'-'||b.street||'-'||b.name = '5620-Wohlerstrasse-Casino';
update obj_building b set building_nr = '5.6' where b.zip||'-'||b.street||'-'||b.name = '5620-Obertorplatz-Stadtschulhaus';
update obj_building b set building_nr = '5.7' where b.zip||'-'||b.street||'-'||b.name = '5620-Promenade-Promendenschulhaus';
update obj_building b set building_nr = '5.8' where b.zip||'-'||b.street||'-'||b.name = '5620-Gartenstrasse-Gartenschulhaus';
update obj_building b set building_nr = '5.9' where b.zip||'-'||b.street||'-'||b.name = '5620-Sportstrasse-Turnhalle Bärenmatt';
update obj_building b set building_nr = '5.10' where b.zip||'-'||b.street||'-'||b.name = '5620-Klosterweg 6-Kindergarten Unterstadt';

update obj_building b set building_nr = '6.1' where b.zip||'-'||b.street||'-'||b.name = '8556-Bernrainstr. 26-Kindergarten Haldengüetli';

update obj_building b set building_nr = '7.1' where b.zip||'-'||b.street||'-'||b.name = '8355-Käsernstrasse 1-Kindergarten Käsernstrasse';
update obj_building b set building_nr = '7.2' where b.zip||'-'||b.street||'-'||b.name = '8355-Schulstrasse 9-Altes Schulhaus Kindergarten';

update obj_building b set building_nr = '8.1' where b.zip||'-'||b.street||'-'||b.name = '3032-Bergfeldstrasse 8-Wohn- und Geschäftshaus';
update obj_building b set building_nr = '8.2' where b.zip||'-'||b.street||'-'||b.name = '3032-Dorfstrasse 45-Feuerwehrmagazin/3 Wohnungen';
update obj_building b set building_nr = '8.3' where b.zip||'-'||b.street||'-'||b.name = '3034-Schulstrasse 4-Schulhaus, Pausenhalle , Kita';
update obj_building b set building_nr = '8.4' where b.zip||'-'||b.street||'-'||b.name = '3034-Schulstrasse 5-Turnhalle und Lehrschwimmbecken';
update obj_building b set building_nr = '8.5' where b.zip||'-'||b.street||'-'||b.name = '3034-Schulstrasse 6-Wohnhaus (2 Wohnungen)';
update obj_building b set building_nr = '8.6' where b.zip||'-'||b.street||'-'||b.name = '3034-Schulstrasse 7-Schulhaus';
update obj_building b set building_nr = '8.7' where b.zip||'-'||b.street||'-'||b.name = '3034-Schulstrasse 9-Schulhaus/ZS-Anlage/Verbindungsgang';
update obj_building b set building_nr = '8.8' where b.zip||'-'||b.street||'-'||b.name = '3032-Araweg 9-Jugendtreff (Pavillon)';
update obj_building b set building_nr = '8.9' where b.zip||'-'||b.street||'-'||b.name = '3032-Hofenstrasse 54-Wohnhaus (private Kindertagesstätte)';
update obj_building b set building_nr = '8.10' where b.zip||'-'||b.street||'-'||b.name = '3034-Kappelenring 36/36a-Primarschule/Doppelturnhalle/KZ/WR';
update obj_building b set building_nr = '8.11' where b.zip||'-'||b.street||'-'||b.name = '3033-Schulgasse 14-Altes Schulhaus/Doppelkindergarten/Klassenzimmer/2 Whg.';
update obj_building b set building_nr = '8.12' where b.zip||'-'||b.street||'-'||b.name = '3033-Schulgasse 14a-Garage (Nebengebäude)';
update obj_building b set building_nr = '8.13' where b.zip||'-'||b.street||'-'||b.name = '3033-Schulgasse 16-Schulhaus, Pausenhalle, ZS-Anlage';
update obj_building b set building_nr = '8.14' where b.zip||'-'||b.street||'-'||b.name = '3033-Schulgasse 18-Doppelturnhalle';
update obj_building b set building_nr = '8.15' where b.zip||'-'||b.street||'-'||b.name = '3033-Hauptstrasse 22-Aufbahrungsgebäude, Abdankungshalle';
update obj_building b set building_nr = '8.16' where b.zip||'-'||b.street||'-'||b.name = '3033-Hauptstrasse 26-Verwaltungsgebäude (Gemeindehaus)';
update obj_building b set building_nr = '8.17' where b.zip||'-'||b.street||'-'||b.name = '3034-Schützenweg 50-Schützenhaus';
update obj_building b set building_nr = '8.18' where b.zip||'-'||b.street||'-'||b.name = '3034-Murzelenstrasse 80-Wohnhaus (3 Whg.)';
update obj_building b set building_nr = '8.19' where b.zip||'-'||b.street||'-'||b.name = '3034-Murzelenstrasse 82A-Garagen/Aussengeräteraum Schule';
update obj_building b set building_nr = '8.20' where b.zip||'-'||b.street||'-'||b.name = '3034-Murzelenstrasse 82-Schulhaus/Kindergarten/Hauswartwohnung';
update obj_building b set building_nr = '8.21' where b.zip||'-'||b.street||'-'||b.name = '3034-Murzelenstrasse 84-Turnhalle';
update obj_building b set building_nr = '8.22' where b.zip||'-'||b.street||'-'||b.name = '3043-Schülerweg 11-ZS-Lager/BSA/Einstellhalle/Rasenspielfeld';
update obj_building b set building_nr = '8.23' where b.zip||'-'||b.street||'-'||b.name = '3043-Schülerweg 12-Doppelkindergarten/Musikschule/Jugendtr.';
update obj_building b set building_nr = '8.24' where b.zip||'-'||b.street||'-'||b.name = '3043-Schülerweg 13-Velounterstand';
update obj_building b set building_nr = '8.25' where b.zip||'-'||b.street||'-'||b.name = '3043-Schülerweg 14-Turnhalle';
update obj_building b set building_nr = '8.26' where b.zip||'-'||b.street||'-'||b.name = '3043-Schülerweg 15-Primarschulhaus, ged. Pausenhalle, Anbau Nord';
update obj_building b set building_nr = '8.27' where b.zip||'-'||b.street||'-'||b.name = '3043-Schülerweg 16-Turnhalle/Hauswartwhg./Heizzentrale';
update obj_building b set building_nr = '8.28' where b.zip||'-'||b.street||'-'||b.name = '3043-Schülerweg 18-Oberstufenschulhaus/Aula';
update obj_building b set building_nr = '8.29' where b.zip||'-'||b.street||'-'||b.name = '3043-Alpenblickweg 10-Velounterstand';
update obj_building b set building_nr = '8.30' where b.zip||'-'||b.street||'-'||b.name = '3049-Staatsstrasse 76-Schulhaus/Hausw.whg./Turnhalle/ZS';
update obj_building b set building_nr = '8.31' where b.zip||'-'||b.street||'-'||b.name = '3043-Lindenstrasse 4-Kulturelles Zentrum Reberhaus';
update obj_building b set building_nr = '8.32' where b.zip||'-'||b.street||'-'||b.name = '3043-Ahornweg 7-Feuerwehrmagazin/Schulungsraum';
update obj_building b set building_nr = '8.33' where b.zip||'-'||b.street||'-'||b.name = '3032-Kappelenring 34a-Kindergarten Kappelenring';

update obj_building b set building_nr = '9.01' where b.zip||'-'||b.street||'-'||b.name = '9470-Schulhausstrasse 4-Wohnhaus (Musikschule)';
update obj_building b set building_nr = '9.02' where b.zip||'-'||b.street||'-'||b.name = '9470-Schulhausstrasse 10-Schulhaus Grof';
update obj_building b set building_nr = '9.03' where b.zip||'-'||b.street||'-'||b.name = '9470-Schulhausstrasse 30-OZ Grof Neubau';
update obj_building b set building_nr = '9.04' where b.zip||'-'||b.street||'-'||b.name = '9470-Schulhausstrasse 27-OZ Grof Altbau';
update obj_building b set building_nr = '9.05' where b.zip||'-'||b.street||'-'||b.name = '9470-Turnhallenstrasse-Turnhalle Buchserbach';
update obj_building b set building_nr = '9.06' where b.zip||'-'||b.street||'-'||b.name = '9470-Turnhallenstrasse 2-Klassenzimmer Buchserbach';
update obj_building b set building_nr = '9.07' where b.zip||'-'||b.street||'-'||b.name = '9470-Turnhallenstrasse 4-Altes Gewerbeschulhaus Buchserbach';
update obj_building b set building_nr = '9.08' where b.zip||'-'||b.street||'-'||b.name = '9470-Kreuzgasse 14-Kindergarten Altendorf';
update obj_building b set building_nr = '9.09' where b.zip||'-'||b.street||'-'||b.name = '9470-Churerstrasse 117-Schulhaus (Neubau) Räfis';
update obj_building b set building_nr = '9.10' where b.zip||'-'||b.street||'-'||b.name = '9470-Churerstrasse 119-Schulhaus (Altbau) Räfis';
update obj_building b set building_nr = '9.11' where b.zip||'-'||b.street||'-'||b.name = '9470-Churerstrasse 119-Magazin';
update obj_building b set building_nr = '9.12' where b.zip||'-'||b.street||'-'||b.name = '9470-Churerstrasse 119-Turnhalle';
update obj_building b set building_nr = '9.13' where b.zip||'-'||b.street||'-'||b.name = '9470-Volksgartenstrasse 1-Kindergarten Kappeli mit Wohnung und Garage';
update obj_building b set building_nr = '9.14' where b.zip||'-'||b.street||'-'||b.name = '9470-Hanflandstr. 5-Schulhaus Hanfland';
update obj_building b set building_nr = '9.15' where b.zip||'-'||b.street||'-'||b.name = '9470-Hanflandstr. 5-Turnhalle';
update obj_building b set building_nr = '9.16' where b.zip||'-'||b.street||'-'||b.name = '9470-Hanflandstr. 3-Kindergarten / HW-Wohnung';
update obj_building b set building_nr = '9.17' where b.zip||'-'||b.street||'-'||b.name = '9470-Birkenaustrasse 12-Kindergarten-Pavillon Birkenau';
update obj_building b set building_nr = '9.18' where b.zip||'-'||b.street||'-'||b.name = '9470-Heldaustrasse 48-Aula OZ Flös';
update obj_building b set building_nr = '9.19' where b.zip||'-'||b.street||'-'||b.name = '9470-Heldaustrasse 50-Schulanlage / Hallenbad';
update obj_building b set building_nr = '9.20' where b.zip||'-'||b.street||'-'||b.name = '9470-Flösweg 3-Kindergarten-Pavillon';
update obj_building b set building_nr = '9.22' where b.zip||'-'||b.street||'-'||b.name = '9470-Volksgartenstrasse 12-Schulhaus Kappeli';
update obj_building b set building_nr = '9.23' where b.zip||'-'||b.street||'-'||b.name = '9470-Volksgartenstrasse 12-Pavillon Hilfsschule';
update obj_building b set building_nr = '9.24' where b.zip||'-'||b.street||'-'||b.name = '8444--altes Postlokal';
