...
import { FieldGroup, FieldRow, Input, Select, SldsEmbeddedFormProps, SldsForm, Static, TextArea } from "@zeitwert/ui-forms";
...
export default class AccountStaticDataForm extends React.Component<AccountStaticDataFormProps> {
	...
	render() {
		...
		return (
			...
			>
				{
					({ formState }: SldsEmbeddedFormProps<AccountModelType>) =>
						<>
