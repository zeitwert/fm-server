...
import io.zeitwert.ddd.collaboration.model.base.ObjNoteBase;
import io.zeitwert.ddd.collaboration.model.db.Tables;
import io.zeitwert.ddd.collaboration.model.db.tables.records.ObjNoteRecord;
...
public class ObjNoteRepositoryImpl extends ObjRepositoryBase<ObjNote, ObjNoteVRecord>
	...
	@Override
	public List<ObjNoteVRecord> doFind(SessionInfo sessionInfo, QuerySpec querySpec) {
		List<ObjNoteVRecord> noteList = this.doFind(sessionInfo, Tables.OBJ_NOTE_V, Tables.OBJ_NOTE_V.ID, querySpec);
		Integer sessionUserId = sessionInfo.getUser().getId();
