...
class ApplicationConfig {
	...
	private final ApplicationArea homeArea = ApplicationArea.builder().id("home").name("Dashboard").icon("standard:home").path("/").component("HomeArea").menu(EmptyMenu).menuAction(homeAction).build();
	...
	private final ApplicationInfo adminFmAppMenu = ApplicationInfo.builder().id("adminFm").name("zeitwert: fm").areas(List.of(buildingArea, portfolioArea, accountArea)).defaultArea(buildingArea.getId()).build();
	...
	private final ApplicationInfo userFmAppMenu = ApplicationInfo.builder().id("userFm").name("zeitwert: fm").areas(List.of(buildingArea, portfolioArea)).defaultArea(buildingArea.getId()).build();
