...
public class ObjAccountVRecord extends TableRecordImpl<ObjAccountVRecord> implements Record20<String, Integer, Integer, String, Integer, OffsetDateTime, Integer, OffsetDateTime, Integer, OffsetDateTime, Integer, Integer, Integer, String, String, String, String, String, Integer, String> {
    ...
    @Override
    public Row20<String, Integer, Integer, String, Integer, OffsetDateTime, Integer, OffsetDateTime, Integer, OffsetDateTime, Integer, Integer, Integer, String, String, String, String, String, Integer, String> valuesRow() {
