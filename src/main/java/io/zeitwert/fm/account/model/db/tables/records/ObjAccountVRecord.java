...
public class ObjAccountVRecord extends TableRecordImpl<ObjAccountVRecord> implements Record19<Integer, String, Integer, Integer, String, Integer, OffsetDateTime, Integer, OffsetDateTime, Integer, OffsetDateTime, Integer, String, String, String, String, String, Integer, String> {
    ...
    @Override
    public Row19<Integer, String, Integer, Integer, String, Integer, OffsetDateTime, Integer, OffsetDateTime, Integer, OffsetDateTime, Integer, String, String, String, String, String, Integer, String> valuesRow() {
    ...
    @Override
    public ObjAccountVRecord value1(Integer value) {
        setTenantId(value);
        return this;
    }

    @Override
    public ObjAccountVRecord value2(String value) {
        setObjTypeId(value);
        return this;
    }
     ...
     */
    public ObjAccountVRecord(Integer tenantId, String objTypeId, Integer id, Integer ownerId, String caption, Integer createdByUserId, OffsetDateTime createdAt, Integer modifiedByUserId, OffsetDateTime modifiedAt, Integer closedByUserId, OffsetDateTime closedAt, Integer objId, String intlKey, String name, String description, String accountTypeId, String clientSegmentId, Integer mainContactId, String referenceCurrencyId) {
        super(ObjAccountV.OBJ_ACCOUNT_V);
