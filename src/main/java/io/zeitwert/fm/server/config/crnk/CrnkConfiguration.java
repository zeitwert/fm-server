...
public class CrnkConfiguration {
	 ...
	 */
	private static class JakartaCrnkFilter implements Filter {
		
		private final CrnkBoot crnkBoot;
		private final String pathPrefix;
		
		public JakartaCrnkFilter(CrnkBoot crnkBoot, String pathPrefix) {
		...
		public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
			...
			if (request instanceof HttpServletRequest httpRequest 
				...
				if (path.startsWith(pathPrefix)) {
					...
					JakartaHttpRequestContext requestContext = new JakartaHttpRequestContext(
